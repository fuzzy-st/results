...
export function nullableValueExample() {
    ...
    function findUserById(id: number, users: Array<{ id: number, name: string }>): Result<{ id: number, name: string } | null> {
    ...
    function findUserByName(name: string, users: Array<{ id: number, name: string }>): Result<{ id: number, name: string } | null> {
...
export async function cachingExample() {
    ...
    console.log("Are timestamps identical?",
        (firstFetch.status === 'success' && firstFetch.data.timestamp) === (secondFetch.status === 'success' && secondFetch.data.timestamp));
