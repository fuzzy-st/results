...
describe('(CORE) `mapError` function', () => {
    ...
    test('should not transform success values', () => {
        ...
        const mappedResult = mapError(successResult, err => new Error('This should not happen'));
    ...
    test('should work with complex error transformations', () => {
        ...
        class AppError extends Error {
            constructor(public code: string, public originalError: Error) {
    ...
    test('should maintain success type', () => {
        ...
        const mappedResult = mapError(userResult, err => new Error('Will not happen'));
